export default {
    ...
    canvas: {
        ...
        connection: { parameterName: "Parameter", unbound: "Unbound", invalid: "Invalid", unsupportedModel: "The current model does not support ComfyUI parameters", unsupportedSource: "Only text nodes can be parameter sources in this release", errors: { workflowMissing: "The current ComfyUI workflow could not be found. Select the model again.", missingParameter: "Parameter {{key}} no longer exists. Select another parameter.", unsupportedSource: "Parameter {{label}} does not support this source type", conflict: "Parameter {{label}} can only have one source", invalidNumber: "Parameter {{label}} must be a number", invalidBoolean: "Parameter {{label}} must be true or false", invalidOption: "The value for {{label}} is not one of the available options", outOfRange: "Parameter {{label}} is outside its allowed range", required: "Enter a value for {{label}}" } },
    ...
    config: {
        ...
        comfyui: {
            description: "Manage local or LAN ComfyUI services and register API workflows as selectable image or video models.",
            ...
            min: "Minimum",
            step: "Step",
            outputHint: "Select at least one output node. Tests and generation read results only from selected nodes. Video workflows support Video Combine / VHS_VideoCombine.",
            noOutputs: "No usable output nodes found. Check for SaveImage, PreviewImage, or Video Combine in the workflow.",
            testHint: "Testing submits one ComfyUI task with the default parameters and reads the selected output.",
            testWorkflow: "Run test",
            testResult: "ComfyUI test result",
            workflowSaved: "Workflow saved",
            workflowTestSuccess: "Workflow test succeeded",
            videoTestLater: "Video workflow testing",
        },
        localStorage: {
