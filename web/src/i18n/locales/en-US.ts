export default {
    ...
    settingsPanels: {
        ...
        image: { title: "Image settings", quality: "Quality", size: "Size", align16: "Align to multiples of 16", align16Hint: "Round dimensions up to the next multiple of 16 after input", aspectRatio: "Aspect ratio", transparent: "Transparent background", transparentHint: "Generate an image without a background when supported by the model", count: "Image count", images: "{{count}} images", negativePrompt: "Negative prompt", negativePromptHint: "Custom scripts / ComfyUI", negativePromptPlaceholder: "For example: blurry ugly bad", workflowParameters: "Workflow parameters" },
        video: { title: "Video settings", quality: "Quality", megapixels: "Megapixels (MP)", size: "Size", seconds: "Seconds", resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
    ...
    config: {
        ...
        comfyui: {
            description: "Manage local or LAN ComfyUI services and register API workflows as selectable image models.",
            serviceName: "ComfyUI service",
            addService: "Add service",
            serviceEditor: "Edit ComfyUI service",
            name: "Service name",
            baseUrl: "Base URL",
            apiKey: "API Key (optional)",
            apiKeyHint: "Local ComfyUI usually does not need one. No Authorization header is sent when empty.",
            corsHint: "Browser access to a local service requires ComfyUI to allow the current page through CORS.",
            ...
            image: "Image",
            video: "Video",
            videoLater: "Video (coming later)",
            workflows: "Workflows",
            workflowHint: "Import the ComfyUI API-format JSON, not the regular UI save format.",
            workflowCount: "{{count}} workflows",
            parameterCount: "{{count}} parameters",
            empty: "No ComfyUI services configured",
            noWorkflows: "No workflows imported",
            importJson: "Import JSON",
            importFailed: "Workflow import failed",
            test: "Test connection",
            testSuccess: "ComfyUI connection succeeded",
            testFailed: "ComfyUI connection failed",
            nameRequired: "Enter a service name",
            urlRequired: "Enter an http:// or https:// URL",
            endpointUrl: "Do not include endpoint paths such as /prompt or /history in the Base URL",
            deleteTitle: "Delete service “{{name}}”?",
            deleteDescription: "This service contains {{count}} workflows. Existing generation records are not affected.",
            deleteWorkflowTitle: "Delete workflow “{{name}}”?",
            workflowEditor: "Edit ComfyUI workflow",
            workflowTab: "Workflow",
            parametersTab: "Input parameters",
            outputsTab: "Output nodes",
            testTab: "Test and save",
            workflowName: "Workflow name",
            capability: "Capability",
            nodeGraph: "Node graph ({{count}} nodes)",
            parameterHint: "Parameters must bind to node inputs. Nodes and fields are validated before saving.",
            addParameter: "Add parameter",
            newParameter: "New parameter",
            label: "Display name",
            nodeId: "Node ID",
            inputKey: "Input field",
            required: "Required",
            defaultValue: "Default value",
            options: "Select options separated by commas",
            min: "Minimum",
            step: "Step",
            outputHint: "Select at least one output node. Tests and generation read images only from selected nodes.",
            noOutputs: "No usable output nodes found. Check for SaveImage or PreviewImage in the workflow.",
            testHint: "Testing submits one ComfyUI task using default prompt values. Video execution will be added later.",
            testWorkflow: "Run test",
            testResult: "ComfyUI test result",
            workflowSaved: "Workflow saved",
            workflowTestSuccess: "Workflow test succeeded",
            videoTestLater: "Video workflow testing will be added later",
        },
        localStorage: {
