export default {
    ...
    canvas: {
        ...
        connection: { parameterName: "参数名", unbound: "未绑定", invalid: "失效", unsupportedModel: "当前模型不支持 ComfyUI 参数绑定", unsupportedSource: "首期仅支持文本节点作为参数来源", errors: { workflowMissing: "找不到当前 ComfyUI 工作流，请重新选择模型", missingParameter: "参数 {{key}} 已不存在，请重新选择", unsupportedSource: "参数 {{label}} 暂不支持此类来源", conflict: "参数 {{label}} 只能绑定一个来源", invalidNumber: "参数 {{label}} 必须是数字", invalidBoolean: "参数 {{label}} 必须是 true 或 false", invalidOption: "参数 {{label}} 的值不在可选范围内", outOfRange: "参数 {{label}} 超出允许范围", required: "请填写参数 {{label}}" } },
    ...
    config: {
        ...
        comfyui: {
            description: "管理本机或局域网 ComfyUI 服务，并将 API 工作流注册为可选择的生图或视频模型。",
            ...
            min: "最小值",
            step: "步进",
            outputHint: "至少选择一个输出节点，测试和正式生成只读取所选节点的结果。视频工作流支持 Video Combine / VHS_VideoCombine。",
            noOutputs: "未识别到可用输出节点，请检查工作流是否包含 SaveImage、PreviewImage 或 Video Combine。",
            testHint: "测试会提交一次 ComfyUI 任务，并使用默认参数读取所选输出。",
            testWorkflow: "运行测试",
            testResult: "ComfyUI 测试结果",
            workflowSaved: "工作流已保存",
            workflowTestSuccess: "工作流测试成功",
            videoTestLater: "视频工作流测试",
        },
        localStorage: {
