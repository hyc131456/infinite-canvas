export default {
    ...
    config: {
        ...
        comfyui: {
            description: "管理本机或局域网 ComfyUI 服务，并将 API 工作流注册为可选择的生图模型。",
            serviceName: "ComfyUI 服务",
            addService: "新增服务",
            serviceEditor: "编辑 ComfyUI 服务",
            name: "服务名称",
            baseUrl: "Base URL",
            apiKey: "API Key（可选）",
            apiKeyHint: "本地 ComfyUI 通常无需填写；留空时不会发送 Authorization 请求头。",
            corsHint: "浏览器直连本地服务需要 ComfyUI 允许当前页面的 CORS 请求。",
            enabled: "启用服务",
            disabled: "已停用",
            online: "在线",
            offline: "连接失败",
            lastTested: "最近测试 {{time}}",
            image: "生图",
            video: "视频",
            videoLater: "视频（后续版本）",
            workflows: "工作流",
            workflowHint: "导入 ComfyUI 的 API 格式 JSON，不要导入普通界面保存格式。",
            workflowCount: "{{count}} 个工作流",
            parameterCount: "{{count}} 个参数",
            empty: "还没有配置 ComfyUI 服务",
            noWorkflows: "还没有导入工作流",
            importJson: "导入 JSON",
            importFailed: "工作流导入失败",
            test: "测试连接",
            testSuccess: "ComfyUI 连接成功",
            testFailed: "ComfyUI 连接失败",
            nameRequired: "请输入服务名称",
            urlRequired: "请输入 http:// 或 https:// 地址",
            endpointUrl: "Base URL 不要包含 /prompt、/history 等具体接口路径",
            deleteTitle: "删除服务“{{name}}”？",
            deleteDescription: "该服务包含 {{count}} 个工作流，删除后不会影响已有生成记录。",
            deleteWorkflowTitle: "删除工作流“{{name}}”？",
            workflowEditor: "编辑 ComfyUI 工作流",
            workflowTab: "工作流",
            parametersTab: "输入参数",
            outputsTab: "输出节点",
            testTab: "测试保存",
            workflowName: "工作流名称",
            capability: "生成能力",
            nodeGraph: "节点图（{{count}} 个节点）",
            parameterHint: "参数必须绑定到节点输入，保存前会校验节点和字段是否存在。",
            addParameter: "新增参数",
            newParameter: "新参数",
            label: "显示名称",
            nodeId: "节点 ID",
            ...
            required: "必填",
            defaultValue: "默认值",
            options: "下拉选项，使用英文逗号分隔",
            min: "最小值",
            step: "步进",
            outputHint: "至少选择一个输出节点，测试和正式生成只读取所选节点的图片结果。",
            noOutputs: "未识别到可用输出节点，请检查工作流是否包含 SaveImage 或 PreviewImage。",
            testHint: "测试会提交一次 ComfyUI 任务，提示词使用默认值；视频工作流的执行器将在后续版本接入。",
            testWorkflow: "运行测试",
            testResult: "ComfyUI 测试结果",
            workflowSaved: "工作流已保存",
            workflowTestSuccess: "工作流测试成功",
            videoTestLater: "视频工作流测试将在后续版本接入",
        },
        localStorage: {
